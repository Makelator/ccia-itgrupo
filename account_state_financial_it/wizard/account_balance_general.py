...
class tc_descuadrados(models.Model):
	...
	tipodecambio = fields.Float('Tipo de Cambio Factura')
	tipo_venta = fields.Float('Tipo de Cambio Sunat')
...
left join (select name,type_sale,type_purchase from res_currency_rate) a2 on a2.name=a1.fechaemision
