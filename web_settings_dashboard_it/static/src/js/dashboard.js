...
var Dashboard = Widget.extend({
    ...
    init: function(parent, data){
        this.all_dashboards = ['apps', 'invitations', 'planner', 'share','itgrupo'];
    ...
    load_itgrupo: function(data){
        return  new DashboardITGrupo(this, data.apps).replace(this.$('.o_web_settings_dashboard_itgrupo'));
    },
...
var DashboardITGrupo = Widget.extend({
    template: 'DashboardITGrupo',

    events: {
        'click .tw_itgrupo': 'share_itgrupo',
    },
    ...
    share_itgrupo: function(){
        var popup_url = _.str.sprintf( 'http://itgrupo.net/' );
    ...
    sharer: function(popup_url){
        var win = window.open(
            popup_url,
            '_blank'); // We have to add a size otherwise the window pops in a new tab
        win.focus();
    }
});
...
return {
    ...
    DashboardITGrupo: DashboardITGrupo,
};
